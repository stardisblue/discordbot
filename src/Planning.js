...
var Planning = /** @class */ (function () {
    ...
    Planning.now = function (message, args) {
        if (args.length !== 2) {
        ...
        ical.fromURL(Resource_1.default.createURL(Resource_1.default.getId("master2", "info", 1, args[1]), 0), {}, function (err, data) {
    ...
    Planning.next = function (message, args) {
        if (args.length !== 2) {
            message.channel.send("`incorrect number of arguments`");
            return;
        }
    ...
    Planning.today = function (message, args) {
        if (args.length < 2) {
            message.channel.send("`incorrect number of arguments`");
            return;
        }
    ...
    Planning.tomorrow = function (message, args) {
        if (args.length !== 2) {
            message.channel.send("`incorrect number of arguments`");
            return;
        }
